            ...
            <div class="h-content-top container">
                <div class="logo ">
                    <a style="background-image:url({{ RvMedia::getImageUrl(theme_option('logo')) }}"
                       href="{{ route('public.index') }}" class="bm_Ci" title="{{ theme_option('site_title') }}">
                    </a>
                </div>
                ...
                <nav class="navbar navbar-expand-lg ">
                    <div class="collapse navbar-collapse container" id="navbarText">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item item-cat {{ Request::is('new') ? "active":""}}">
                                <a class="nav-link" href="{{url("/new")}}" title="Home">New</a>
                            </li>
